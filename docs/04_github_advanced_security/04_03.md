...
2. You will see findings from the `ZavaStorefront.csproj` file. Previously, this would have shown a recommendation to update from .NET 6 to .NET 8, but the project has now been upgraded to .NET 8 (LTS).
